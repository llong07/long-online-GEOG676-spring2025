...
def execute(self, parameters, messages):
    ...
    folder_path = parameters[0].valuesAsText
    ...
    campus = parameters[4].valuesAsText
    ...
    arcpy.TableToTable_conversion( gdb_path + '\Garage_Buildings_Intersection.dbf', r'C:\Users\stockhart0192\Devsource\Stockhart-Geog676\Lab5', 'nearbyBuildings')
